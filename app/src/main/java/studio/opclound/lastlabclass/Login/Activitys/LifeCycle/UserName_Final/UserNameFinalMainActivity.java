package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.UserName_Final;
...
public class UserNameFinalMainActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.username_final_activity_main);
