...
package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.AssetsFloder;
 ...
 */
public class AssetsFloderMainActivity extends AppCompatActivity {

    private static final String TAG_LOG = AssetsFloderMainActivity.class.getSimpleName();
    private static final int MY_PERMISSIONS_REQUEST_WRITE_LOCAL_STORAGE = 121;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.assets_floder_activity_main);
