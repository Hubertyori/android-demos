...
package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.AppPrivateDirectory;
...
public class AppPrivateDirectoryMainActivity extends AppCompatActivity {

    private static final String LOG_TAG = AppPrivateDirectoryMainActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.app_private_directory_activity_main);
