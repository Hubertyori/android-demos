package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.Button_Design;
...
public class ButtonDesignMainActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.button_design_activity_main);
