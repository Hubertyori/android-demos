...
public class Login extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         * the user already logged in, is yest  then go to the LifeCycleMainActivity
         */
    ...
    public void btnLogin(View view) {
        ...
        if (!email.isEmpty() && !password.isEmpty()) {
            ...
            if (CheckTheNetConnection()) {
                ...
                { Toast.makeText(Login.this, "Please check your net-connection", Toast.LENGTH_LONG).show();}
            }
            else{
                Toast.makeText(Login.this, "Please check your net-connection", Toast.LENGTH_LONG).show();
            }
    ...
    private boolean CheckTheNetConnection() {
...
//            Toast.makeText(Register.this, "Please check your net-connection", Toast.LENGTH_LONG).show();
            return false;
        }
    }
    ...
    class OnlineCredentialValidation extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer mFeedback) {
            ...
            if (mFeedback == feedback.SUCCESS) {
                ...
                // Move the user to LifeCycleMainActivity and pass in the User name which was form the server
