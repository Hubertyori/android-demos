package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.ListView2;
...
public class ListView2MainActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.list_view_2_activity_main);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter(this, R.layout.list_view_2_item_layout, R.id.item_text, arrayDemo);
