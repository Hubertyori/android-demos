package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.Layout;
		...
		myListView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				case 0:
					...
					startActivity(new Intent(LayoutMainActivity.this,LayoutActivityLinearLayout.class));
					break;
				case 1:
					//Start Activity RelativeLayout				
					startActivity(new Intent(LayoutMainActivity.this,LayoutActivityRelativelayout.class));
					break;
