package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.RadioButtons_Listener;
...
public class RadioButtonsListenerMainActivity extends Activity implements OnCheckedChangeListener {
	RadioGroup radiogroup;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.redio_button_listener_activity_main);
