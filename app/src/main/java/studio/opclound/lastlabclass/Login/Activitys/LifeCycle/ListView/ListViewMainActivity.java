...
package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.ListView;
...
public class ListViewMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        ArrayAdapter<String> mAdapter = new ArrayAdapter<String>(this, R.layout.list_view_list_item, R.id.tv_item, dummyData);
