package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.GetColor;
...
public class GetColorMainActivity extends AppCompatActivity {
    TextView display_color;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.get_color_activity_main);
