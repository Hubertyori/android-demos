package studio.opclound.lastlabclass.Login.Activitys.LifeCycle.ServiceDemo;
...
public class MyService extends Service {
    ...
    //from MyService to ServiceDemoMainActivity
    ...
    //from ServiceDemoMainActivity to MyService
    ...
    public class MyServiceReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(ACTION_MSG_TO_SERVICE)) {
                ...
                //send back to ServiceDemoMainActivity
                Intent i = new Intent();
